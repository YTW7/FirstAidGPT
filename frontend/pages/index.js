...
export default function Home() {
  ...
  const [messages, setMessages] = useState([
    {
      "message": "FirstAidGPT reporting! How can I assist you?",
      "type": "apiMessage"
    }
  ]);
      ...
      <div className = {styles.cloud}>
        ...
        {messages.map((message, index) => {
          ...
          />
            ...
            <p>Powered by <a href = "https://github.com/openai" target="_blank">OpenAI</a>. Built by <a href="https://twitter.com/yahyathwarrior" target="_blank">Team - Real Dev</a>.</p>
            </div>
        </div>
      </main>
    </>
